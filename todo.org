** TODO [#A] Create SIERRA pypi package [75%]
...
- [ ] Rename xml_luigi to something that makes more sense
- [ ] More SAANoise out of SIERRA--to uses the perf.robustness dictionary, which I am moving out to TITERRA
- [ ] Document all the SIERRA hooks that exist/I use in TITERRA


** TODO [#B] Fix the pylint import error false positives
** TODO [#B] Updates docs for the config (stage5, main)
