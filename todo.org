* SIERRA                                                            :sierra:
** TODO [#B] Add additional integration tests [60%]
...
** TODO Make cmdline a first-class plugin, update tutorials
...
** TODO [#B] Remove **kwargs usage from graphs--explicit arguments leads to way
better type checking
** TODO [#B] Add .sierrarc to read common cmdline args/envvar settings from
...
** TODO [#C] Fix all links in document to not be prefixed with 'ln-sierra'
