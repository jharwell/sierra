...
:Release:
   ...
   |ci-analysis-master| |ci-coverage-master| |ci-integration-master| |ci-unit-tests-master|

:Development:

   |ci-analysis-devel| |ci-coverage-devel| |ci-integration-devel| |ci-unit-tests-devel|
