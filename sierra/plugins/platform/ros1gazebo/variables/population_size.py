    ...
    def gen_element_addlist(self) -> tp.List[definition.ElementAddList]:
        ...
        if not self.element_adds:
            ...
            for s in self.sizes:
                ...
                exp_adds.append(definition.ElementAdd(".",
                                                      "master",
                                                      {},
                                                      True))
                exp_adds.append(definition.ElementAdd("./master",
                                                      "group",
                                                      {
                                                          'ns': 'sierra'
                                                      },
                                                      False))
                exp_adds.append(definition.ElementAdd("./master/group/[@ns='sierra']",
                                                      "param",
                                                      {
                ...
                for i in range(0, s):
                    ...
                    exp_adds.append(definition.ElementAdd("./robot",
                                                          "group",
                                                          {
                                                              'ns': ns
                                                          },
