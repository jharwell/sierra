...
def _build_multistage(cmdline: PluginCmdline) -> PluginCmdline:
    ...
    cmdline.multistage.add_argument(
        ...
        help="""
             ...
             Mainly useful when the batch criteria xticks have a very large
             numeric range, but only a small set of values within that range, to
    ...
    cmdline.multistage.add_argument(
        ...
        help="""
             ...
             inter-experiment graphs into the logarithmic space.  Mainly useful
             when the batch criteria xticks have a very large numeric range, so
    ...
    cmdline.multistage.add_argument(
        ...
        help="""
             ...
             of the OTHER criteria on various performance measures.
...
def _build_stage4(cmdline: PluginCmdline) -> PluginCmdline:
    ...
    cmdline.stage4.add_argument(
        "--graphs-no-SP",
        help="""
             Specify that scatterplots defined in project YAML configuration
             should not be generated.  Useful if you are working on something
             which results in the generation of other types of graphs, and the
             generation of scatterplots only slows down your development cycle.
...
def to_cmdopts(args: argparse.Namespace) -> types.Cmdopts:
    return {
        ...
        "graphs": args.graphs,
        "graphs_no_LN": args.graphs_no_LN,
        "graphs_no_HM": args.graphs_no_HM,
        "graphs_no_CM": args.graphs_no_CM,
