...
"""
Experiment generation classes, generating definitions common to all batch experiments, as well as
...
class BatchExpDefGenerator:
    """Class for generating experiment definitions for a batch experiment. Does
    not create the batch experiment after generation.
