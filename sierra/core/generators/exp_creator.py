...
``exp_generators.py`` and writing the experiment to the filesystem.
"""
...
class ExpCreator:
    ...
    :class:`~sierra.core.generators.exp_generators.BatchedExpDefGenerator` by writing out simulation
    input files and setting up the necessary directory structure.
    ...
    def from_def(self, exp_def: XMLLuigi):
        ...
        be meaningfully computed post-hoc.
        ...
        for sim_num in range(self.cmdopts['n_sims']):
            ...
            per_sim = pm.module_load_tiered(self.cmdopts['project'], 'generators.exp_generators')
            ...
            if self.cmdopts['argos_rendering']:
                ...
                sierra.core.utils.dir_create_checked(frames_fpath, exist_ok=True)
...
class BatchedExpCreator:
    ...
    :class:`~sierra.core.generators.exp_generators.BatchedExpDefGenerator`, by invoking
    :class:`~sierra.core.generators.exp_creator.ExpCreator` on each experimental definition.
    ...
    def create(self, generator) -> None:
        sierra.core.utils.dir_create_checked(self.batch_input_root, self.cmdopts['exp_overwrite'])
