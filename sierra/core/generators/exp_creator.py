...
class ExpCreator:
    ...
    :class:`~sierra.core.generators.exp_generator.BatchedExpDefGenerator` by writing out simulation input
...
class BatchedExpCreator:
    ...
    :class:`~sierra.core.generators.exp_generator.BatchedExpDefGenerator`, by invoking
