    ...
    def gen_attr_changelist(self) -> tp.List[XMLAttrChangeSet]:
        if not self.attr_changes:
            if self.ros_param_server:
                chg1 = XMLAttrChange("./launch/param/[@name='sierra/experiment/length']",
                                     "value",
                                     str(self.n_secs_per_run))
                chg2 = XMLAttrChange("./launch/param/[@name='sierra/experiment/ticks_per_sec']",
                                     "value",
                                     str(self.n_ticks_per_sec))
            else:
                chg1 = XMLAttrChange("./params/sierra/experiment",
                                     "length",
                                     str(self.n_secs_per_run))
