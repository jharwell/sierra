...
class PipelineStage4:
    ...
    def run(self, criteria: bc.IConcreteBatchCriteria) -> None:
        ...
        #. :class:`~sierra.core.pipeline.stage4.video_renderer.BatchExpParallelVideoRenderer` to render
        ...
        #. :class:`~sierra.core.pipeline.stage4.intra_exp_graph_generator.BatchIntraExpGraphGenerator` to
        ...
        #. :class:`~sierra.core.pipeline.stage4.graph_collator.UnivarGraphCollator` or
           :class:`~sierra.core.pipeline.stage4.graph_collator.BivarGraphCollator` as appropriate
           (depending on which type of :class:`~sierra.core.variables.batch_criteria.BatchCriteria` was
