...
((nil .
      ((eval progn
             ...
             (add-to-list 'projectile-globally-ignored-directories "docs/autoapi")
             ...
             (add-to-list 'projectile-globally-ignored-directories ".nox/")
             ...
             (add-to-list 'grep-find-ignored-files "*.css")
