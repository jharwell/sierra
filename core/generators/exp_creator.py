...
class ExpCreator:
    ...
    :class:`~core.generators.exp_generator.BatchedExpGenerator` by writing out simulation input
...
class BatchedExpCreator:
    ...
    :class:`~core.generators.exp_generator.BatchedExpGenerator`, by invoking
