...
class BatchedIntraExpGraphGenerator:
    ...
    """
    Generates all intra-experiment graphs from a batched experiments using a
    :class:`IntraExpGraphGenerator` in the directory for each experiment's directory in the batch.
