...
selection and renaming, collision detection, and exact-match-relative-to-
output-root file resolution (including ambiguity errors; a source that does not
resolve to exactly one file is an error, never a substring fan-out).
...
class TestValidateWhole:
    ...
    def test_non_list_top_level_rejected(self):
        # collate.yaml is a flat list of targets; a mapping at the top level is
        # rejected.
...
class TestValidateErrors:
    ...
    def test_unknown_key_rejected(self):
        """strictyaml's default strictness rejects unknown keys."""
