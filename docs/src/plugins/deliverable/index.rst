...
.. _plugins/deliverable:

==============================
Deliverable Generation Plugins
==============================
...
.. _plugins/deliverable/dataflow/intra:

Intra-Experiment Deliverables
-----------------------------
...
.. _plugins/deliverable/dataflow/inter:

Inter-Experiment Deliverables
-----------------------------
...
With that context and framing, the documentation for each of the deliverable
