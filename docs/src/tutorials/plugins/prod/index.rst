...
:ref:`concepts/dataflow/stage4` to get a brief overview of how data flows
through the pipeline w.r.t. stage 4, and :ref:`tutorials/plugins/devguide` for a
