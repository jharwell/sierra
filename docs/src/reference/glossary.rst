...
.. glossary::
   ...
   Project
      ...
      utility classes which allow SIERRA to translate the
      ``--scenario`` argument passed on the cmdline to
      sets of expdef changes as part of :term:`Experiment` definition.
      ...
      Specified via :ref:`--project<src/reference/cli:sierra---project>` on
      the cmdline.
   ...
   Batch Experiment
      ...
      file passed to SIERRA during stage 1 via
   ...
   Experimental Run
      ...
      together by SIERRA in stage 3 is controlled by
