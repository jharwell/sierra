...
.. glossary::
   ...
   Batch Criteria
      ...
      :ref:`plugins/platform/argos/bc/population-size`), in which case it is
      called `univariate`, or have two axes (such as
      :ref:`plugins/platform/argos/bc/population-size` and another batch
   ...
   Batch Experiment
      ...
      For example, for the :ref:`plugins/platform/argos/bc/population-size`
