...
.. glossary::
   ...
   Batch Criteria
      ...
      :ref:`ln-sierra-platform-argos-bc-population-size`), in which case it is called
      `univariate`, or have two axes (such as
      :ref:`ln-sierra-platform-argos-bc-population-size` and another batch criteria
      such as one defining sensor and actuator noise to apply to the robots), in
      which case it is called `bivariate`.
   ...
   Batch Experiment
      ...
      For example, for the :ref:`ln-sierra-platform-argos-bc-population-size` batch
