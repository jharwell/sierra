...
#. Determine how to invoke Sierra. Full documentation of all command line
   options it accepts is an :ref:`ln-cli`, and there are many useful options
   that Sierra accepts, so skimming the CLI docs is **very** worthwhile. At a
   minimum you need to tell it the following:
