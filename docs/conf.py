...
# built documents.
#
release = importlib.metadata.version("sierra-research")
# Short X.Y version for the docs (Sphinx convention: `version` = short, `release` = full)
version = release
...
nitpick_ignore = [
    ...
    ("py:class", "sierra.core.types.Cmdopts"),
    ("py:class", "sierra.core.types.YAMLDict"),
    ("py:class", "sierra.core.types.SimpleDict"),
    ("py:class", "sierra.core.types.StrDict"),
    ("ref:class", "sierra.core.types.StrDict"),
    ("py:class", "sierra.core.types.IntDict"),
    ("py:class", "sierra.core.types.PathList"),
    ("py:class", "sierra.core.types.CLIArgSpec"),
    ("py:class", "sierra.core.types.ModuleType"),
    ("py:class", "TypeAlias"),
...
plantuml_args = [
    "-Dplantuml.include.path=%s" % os.path.join(os.path.dirname(__file__), "figures")
]
