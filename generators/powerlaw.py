...
class PLGenerator(BaseScenarioGenerator):
    ...
    def generate(self):
        ...
        BaseScenarioGenerator.generate_block_dist(exp_def, ev.block_distribution.TypePowerLaw())

        # Generate and apply nest definitions
        BaseScenarioGenerator.generate_nest_pose(exp_def, arena_dim, "powerlaw")
